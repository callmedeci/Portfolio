      ...
      >
        ...
        >
          <motion.h2
            ...
            className='relative text-2xl font-bold text-zinc-800 after:absolute after:bottom-0.5 after:left-0 after:h-0.5 after:w-26 after:bg-emerald-500 after:content-[""] md:text-4xl dark:text-zinc-200'
          >
            Contact me
          </motion.h2>
