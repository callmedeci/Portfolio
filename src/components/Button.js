...
function Button({ children, className, icon, variant = 'main', onClick }) {
  ...
  const style = {
    ...
    link: 'hover:bg-zinc-800 hover:text-emerald-500 hover:shadow-md justify-center text-emerald-400 text-sm xl:text-base',
    toggle:
      'bg-zinc-800 text-zinc-400 hover:text-emerald-600 rounded-full shadow-md',
    danger: 'text-zinc-500 hover:text-rose-500',
  };
